    ...
    public partial class InitDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_resposta_tem_alternativa", x => new { x.AlternativaId, x.RespostaId });
                    table.ForeignKey(
                        name: "FK_resposta_tem_alternativa_alternativa_AlternativaId",
                        column: x => x.AlternativaId,
                        principalTable: "alternativa",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_resposta_tem_alternativa_resposta_RespostaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_resposta_tem_alternativa_RespostaId_AlternativaId",
                table: "resposta_tem_alternativa",
                columns: new[] { "RespostaId", "AlternativaId" },
                unique: true);
