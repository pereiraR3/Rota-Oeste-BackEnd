    ...
    public partial class InitDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_resposta_tem_alternativa", x => new { x.id_alternativa, x.id_resposta });
                    table.ForeignKey(
                        name: "FK_resposta_tem_alternativa_alternativa_id_alternativa",
                        column: x => x.id_alternativa,
                        principalTable: "alternativa",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_resposta_tem_alternativa_resposta_id_resposta",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_resposta_tem_alternativa_id_resposta_id_alternativa",
                table: "resposta_tem_alternativa",
                columns: new[] { "id_resposta", "id_alternativa" },
                unique: true);
